    ...
    return (
        <div>
            <div className='relative'>
                ...
                <div className='absolute inset-0 py-4 flex justify-center items-center'>
                    <div className='max-w-[1000px] w-full px-[30px] md:px-0'>
                        <div className='flex flex-col gap-[30px] xs:gap-[50px] md:gap-[30px]'>
                            <div className='flex flex-col gap-[10px] md:gap-5'>
                                ...
                                <div className='flex flex-col text-white text-[12px] md:text-sm text-left'>
                            ...
                            <div className='flex flex-col gap-0.5 text-secondary text-[10px] md:text-sm font-bold text-left leading-normal'>
                                <span>Copyright © Quantum Capital Group 2021. All rights reserved.</span>
                                <span>NFA ID: 0555532 | SVGFSA: 26397 2021</span>
                            </div>
                            <div className='flex flex-col gap-[10px]'>
                                <span className='text-red text-xs font-bold text-left leading-normal'>Risk Warning: </span>
                                <span className='text-white text-[10px] text-left leading-tight md:leading-normal'>
